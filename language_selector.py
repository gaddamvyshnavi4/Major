...
st.write("welcome to crop yield prediction application")
st.write("choose app if you want to get screen in english ")
st.write("choose tapp if you want to get screen in telugu ")
'''engine = pyttsx3.init()
def speak(text):
    engine.say(text)
    engine.runAndWait()
